...
subtitle: >-
  用一张 IDE 后台 Credits 用量截图，对比 ClaudeCode+DeepSeek 的 OCR 退化与 CodeBuddy+kimi-k2.7
  的原生多模态理解，揭示多模态为何是任务完成的硬门槛。
...
excerpt: >-
  ...
  $30K），CodeBuddy+kimi-k2.7 原生读懂 UI 层级与遮挡。多模态不是附加功能，而是任务完成的硬门槛。
image: resources/cover.zh.png
toc: true
ghp_canonical_url: ''
ghp_series: ''
